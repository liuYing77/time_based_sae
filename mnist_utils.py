...
def get_train_data(dir_path='.'):
    file_name = os.path.join(dir_path, 'train-images-idx3-ubyte')
    #print file_name
    ...
    file_name = os.path.join(dir_path, 'train-labels-idx1-ubyte')
    f = open(file_name, "rb")
...
def get_test_data(dir_path='./'):
    file_name = os.path.join(dir_path, 't10k-images-idx3-ubyte')
    f = open(file_name, "rb")
    magic_number, list_size, image_hight, image_width  = np.fromfile(f, dtype='>i4', count=4)
    ...
    file_name = os.path.join(dir_path, 't10k-labels-idx1-ubyte')
    f = open(file_name, "rb")
    magic_number, list_size = np.fromfile(f, dtype='>i4', count=2)
